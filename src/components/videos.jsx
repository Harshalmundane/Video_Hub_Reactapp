    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={"flex-start"} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            This is a sample Video for testing And Demo <br /> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat rerum,
            sed accusamus consequatur rem itaque facilis officiis minima tempore eos nemo! Tenetur,
            qui vitae. Numquam adipisci quisquam architecto, blanditiis error magnam sunt enim voluptatum.
          </Text>
        </VStack>
      </VStack>
